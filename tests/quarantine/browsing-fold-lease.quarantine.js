...
describe('browsing automatic fold lease', () => {
  it.skip('keeps the row that was latest when browsing started after an append', () => {
  ...
  it.skip('is bounded by current rows and may adopt a newly witnessed latest row', () => {
  ...
  it.skip('revokes the lease on following or activation replacement', () => {
  ...
  it.skip('keeps the lease across a reciprocal semantic replacement in the same visual slot', () => {
    const old = reconcileBrowsingFoldLease(emptyBrowsingFoldLease(), {
