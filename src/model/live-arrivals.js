...
function acknowledgement(type, throughRevision) {
...
export function acknowledgeLiveTimelineArrivals(throughRevision) {
  return acknowledgement(LIVE_ARRIVAL_RECEIPT.acknowledgeTimeline, throughRevision);
}
