...
export function SidePanel({ ariaLabel, eyebrow, title, closeLabel = `关闭${title}`, headerActions, tabs = [], activeTab, onTabChange, onClose, className = '', children }) {
  ...
  return <aside className={classes} aria-label={ariaLabel}>
    <header className="side-panel-header">
      ...
      <div className="side-panel-header-actions">{headerActions}<button type="button" className="icon-button" onClick={onClose} aria-label={closeLabel}>×</button></div>
    </header>
